            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <ul class="list-inline navbar-prof">
                        ...
                        if($idlogin !=$profileID){
                        ?>
                        <li><a href="#" class="reportUser">Report</a></li>
                        <?php } ?>
                    </ul>
...
<?php
        ...
        <div class="overlay-report">
            <i class="fa fa-close"></i>
            <div class="content"><textarea rows="" cols="" class="report-text" placeholder="Why need report this user"></textarea>
            <div class="btn btn-primary send-report" data-idprofile="<?php echo $profileID ?>"><i class="fa fa-envelope"></i> Send</div></div>
